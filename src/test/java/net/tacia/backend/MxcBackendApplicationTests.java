...
class MxcBackendApplicationTests {
    ...
    void shouldReturnOkWhenAccessingRootStructure() throws Exception {
        ...
        when(contentRepository.findByPath("/")).thenReturn(java.util.Optional.of(new ContentItem("", "directory", "/", 0, null)));
    ...
    void shouldReturnOkWhenAccessingSubdirectoryStructure() throws Exception {
        ...
        when(contentRepository.findByPath(subdirPath)).thenReturn(java.util.Optional.of(new ContentItem("docs", "directory", subdirPath, 0, null)));
